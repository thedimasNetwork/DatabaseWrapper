...
public class MatchesRecord extends UpdatableRecordImpl<MatchesRecord> implements Record9<Integer, OffsetDateTime, OffsetDateTime, PvpMode, String, String[], String[], String[], String[]> {
    ...
    @Override
    public Row9<Integer, OffsetDateTime, OffsetDateTime, PvpMode, String, String[], String[], String[], String[]> valuesRow() {
    ...
    @Override
    public MatchesRecord values(Integer value1, OffsetDateTime value2, OffsetDateTime value3, PvpMode value4, String value5, String[] value6, String[] value7, String[] value8, String[] value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MatchesRecord(Integer id, OffsetDateTime started, OffsetDateTime finished, PvpMode mode, String map, String[] teamA, String[] teamB, String[] teamC, String[] teamD) {
        super(Matches.matches);
