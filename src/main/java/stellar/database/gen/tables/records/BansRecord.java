...
public class BansRecord extends UpdatableRecordImpl<BansRecord> implements Record7<Integer, String, String, OffsetDateTime, OffsetDateTime, String, Boolean> {
    ...
    @Override
    public Row7<Integer, String, String, OffsetDateTime, OffsetDateTime, String, Boolean> valuesRow() {
    ...
    @Override
    public BansRecord values(Integer value1, String value2, String value3, OffsetDateTime value4, OffsetDateTime value5, String value6, Boolean value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public BansRecord(Integer id, String admin, String target, OffsetDateTime created, OffsetDateTime until, String reason, Boolean active) {
        super(Bans.bans);
